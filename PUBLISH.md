...
Publisher **`clawagents`** · source https://github.com/x1jiang/clawagents-vscode · version **1.0.28**
...
- [x] VSIX built: `clawagents-1.0.28.vsix`
...
VSCE_PAT='paste-token-here' npx @vscode/vsce publish --packagePath ./clawagents-1.0.28.vsix
...
```bash
npx ovsx publish ./clawagents-1.0.28.vsix -p "$OVSX_PAT"
```
