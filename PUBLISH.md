...
Publisher **`clawagents`** · source https://github.com/x1jiang/clawagents-vscode · version **1.0.44**
...
- [x] **Publish `clawagents` 6.16.0 to PyPI first** (1.0.44 requires `>=6.16.0`)
- [x] VSIX built: `clawagents-1.0.44.vsix`
...
VSCE_PAT='paste-token-here' npx @vscode/vsce publish --packagePath ./clawagents-1.0.44.vsix
...
```bash
npx ovsx publish ./clawagents-1.0.44.vsix -p "$OVSX_PAT"
```
