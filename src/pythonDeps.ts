...
export const SIDECAR_PIP_PACKAGES = [
  ...
  // 6.17.3: Tier-2 hook/hunk/rewind/bwrap wiring + complete→chat fix.
  "clawagents[gemini,anthropic,bedrock,mcp]>=6.17.3,<7",
  "fastapi>=0.115.0,<1",
  "uvicorn>=0.30.0,<1",
  "pydantic>=2.7.0,<3",
...
export const MIN_CLAWAGENTS_VERSION: [number, number, number] = [6, 17, 3];
