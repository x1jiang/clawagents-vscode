...
export const SIDECAR_PIP_PACKAGES = [
  ...
  // 6.16.0: ATLAS removed; Goal autopilot is the long-horizon path.
  "clawagents[gemini,anthropic,bedrock,mcp]>=6.16.0,<7",
  "fastapi>=0.115.0,<1",
  "uvicorn>=0.30.0,<1",
  "pydantic>=2.7.0,<3",
...
export const MIN_CLAWAGENTS_VERSION: [number, number, number] = [6, 16, 0];
