...
export const SIDECAR_PIP_PACKAGES = [
  ...
  // 6.18.0: hashline / RTK wrap / shell session / auto-bg execute harness.
  "clawagents[gemini,anthropic,bedrock,mcp]>=6.18.0,<7",
  "fastapi>=0.115.0,<1",
  "uvicorn>=0.30.0,<1",
  "pydantic>=2.7.0,<3",
...
export const MIN_CLAWAGENTS_VERSION: [number, number, number] = [6, 18, 0];
